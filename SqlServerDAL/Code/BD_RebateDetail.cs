...
namespace Hi.SQLServerDAL
{
    ...
    public partial class BD_RebateDetail
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Hi.Model.BD_RebateDetail model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Hi.Model.BD_RebateDetail model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetMaxId()
        {
            return SqlHelper.GetMaxID(SqlHelper.LocalSqlServer, "[ID]", "[BD_RebateDetail]");
        }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from [BD_RebateDetail]");
            strSql.Append(" where [ID]= @ID");
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.BigInt)};
            parameters[0].Value = ID;
        ...
        /// 得到一个对象实体
        /// </summary>
        public Hi.Model.BD_RebateDetail GetModel(int ID)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from [BD_RebateDetail] ");
            strSql.Append(" where [ID]=@ID");
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.BigInt)};
            parameters[0].Value = ID;
        ...
        /// </summary>
        public IList<Hi.Model.BD_RebateDetail> GetList(string strSql)
        {
        ...
        /// 获取泛型数据列表,在单表查询时使用
        /// </summary>
        public IList<Hi.Model.BD_RebateDetail> GetList(string strWhat, string strWhere, string strOrderby)
        {
        ...
        /// 分页获取泛型数据列表
        /// </summary>
        public IList<Hi.Model.BD_RebateDetail> GetList(int pageSize, int pageIndex, string fldSort, bool sort, string strCondition, out int pageCount, out int count)
        {
            string strSql;
            DataSet ds = SqlHelper.PageList(SqlHelper.LocalSqlServer, "[BD_RebateDetail]", null, pageSize, pageIndex, fldSort, sort, strCondition, "ID", false, out pageCount, out count, out strSql);
            return GetList(ds);
        }
        #endregion
        ...
        /// 由一行数据得到一个实体
        /// </summary>
        private Hi.Model.BD_RebateDetail GetModel(DataRow r)
        {
            Hi.Model.BD_RebateDetail model = new Hi.Model.BD_RebateDetail();
            model.ID = SqlHelper.GetInt(r["ID"]);
            model.RebateID = SqlHelper.GetInt(r["RebateID"]);
            model.OrderID = SqlHelper.GetInt(r["OrderID"]);
            model.EnableAmount = SqlHelper.GetDecimal(r["EnableAmount"]);
            model.Amount = SqlHelper.GetDecimal(r["Amount"]);
