...
namespace Hi.SQLServerDAL
{
    ...
    public partial class YZT_CMerchants
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Hi.Model.YZT_CMerchants model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Hi.Model.YZT_CMerchants model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete [YZT_CMerchants] ");
            strSql.Append(" where [ID]=@ID");
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.Int)};
        ...
        public int GetMaxId()
        {
            return SqlHelper.GetMaxID(SqlHelper.LocalSqlServer, "[ID]", "[YZT_CMerchants]");
        }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from [YZT_CMerchants]");
            strSql.Append(" where [ID]= @ID");
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.Int)};
            parameters[0].Value = ID;
        ...
        /// 得到一个对象实体
        /// </summary>
        public Hi.Model.YZT_CMerchants GetModel(int ID)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from [YZT_CMerchants] ");
            strSql.Append(" where [ID]=@ID");
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.Int)};
            parameters[0].Value = ID;
        ...
        /// </summary>
        public IList<Hi.Model.YZT_CMerchants> GetList(string strSql)
        {
        ...
        public DataSet GetDataSet(string strWhat, string strWhere, string strOrderby)
        {
            if (string.IsNullOrEmpty(strWhat))
                strWhat = "*";
            StringBuilder strSql = new StringBuilder("select " + strWhat + " from [YZT_CMerchants]");
        ...
        /// 获取泛型数据列表,在单表查询时使用
        /// </summary>
        public IList<Hi.Model.YZT_CMerchants> GetList(string strWhat, string strWhere, string strOrderby)
        {
        ...
        /// 分页获取泛型数据列表
        /// </summary>
        public IList<Hi.Model.YZT_CMerchants> GetList(int pageSize, int pageIndex, string fldSort, bool sort, string strCondition, out int pageCount, out int count)
        {
            string strSql;
            DataSet ds = SqlHelper.PageList(SqlHelper.LocalSqlServer, "[YZT_CMerchants]", null, pageSize, pageIndex, fldSort, sort, strCondition, "ID", false, out pageCount, out count, out strSql);
            return GetList(ds);
        }
        #endregion
        ...
        /// 由一行数据得到一个实体
        /// </summary>
        private Hi.Model.YZT_CMerchants GetModel(DataRow r)
        {
            Hi.Model.YZT_CMerchants model = new Hi.Model.YZT_CMerchants();
            model.ID = SqlHelper.GetInt(r["ID"]);
            model.CompID = SqlHelper.GetInt(r["CompID"]);
            model.IsEnabled = SqlHelper.GetInt(r["IsEnabled"]);
            model.CMCode = SqlHelper.GetString(r["CMCode"]);
            model.CMName = SqlHelper.GetString(r["CMName"]);
            ...
            model.Specify = SqlHelper.GetString(r["Specify"]);
            model.ProvideData = SqlHelper.GetString(r["ProvideData"]);
        ...
        /// 由数据集得到泛型数据列表
        /// </summary>
        private IList<Hi.Model.YZT_CMerchants> GetList(DataSet ds)
        {
            List<Hi.Model.YZT_CMerchants> l = new List<Hi.Model.YZT_CMerchants>();
