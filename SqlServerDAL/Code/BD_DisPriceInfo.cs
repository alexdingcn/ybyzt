...
{
    /// <summary>
    /// 数据访问类 BD_DisPriceInfo
    /// </summary>
    public partial class BD_DisPriceInfo
    {
        public BD_DisPriceInfo()
        { }
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Hi.Model.BD_DisPriceInfo model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Hi.Model.BD_DisPriceInfo model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetMaxId()
        {
            return SqlHelper.GetMaxID(SqlHelper.LocalSqlServer, "[ID]", "[BD_DisPriceInfo]");
        }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from [BD_DisPriceInfo]");
            strSql.Append(" where [ID]= @ID");
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.BigInt)};
            parameters[0].Value = ID;
        ...
        /// 得到一个对象实体
        /// </summary>
        public Hi.Model.BD_DisPriceInfo GetModel(int ID)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// </summary>
        public IList<Hi.Model.BD_DisPriceInfo> GetList(string strSql)
        {
        ...
        public DataSet GetDataSet(string strWhat, string strWhere, string strOrderby)
        {
            if (string.IsNullOrEmpty(strWhat))
                strWhat = "*";
            StringBuilder strSql = new StringBuilder("select " + strWhat + " from [BD_DisPriceInfo]");
        ...
        /// 获取泛型数据列表,在单表查询时使用
        /// </summary>
        public IList<Hi.Model.BD_DisPriceInfo> GetList(string strWhat, string strWhere, string strOrderby)
        {
        ...
        /// 分页获取泛型数据列表
        /// </summary>
        public IList<Hi.Model.BD_DisPriceInfo> GetList(int pageSize, int pageIndex, string fldSort, bool sort, string strCondition, out int pageCount, out int count)
        {
            string strSql;
            DataSet ds = SqlHelper.PageList(SqlHelper.LocalSqlServer, "[BD_DisPriceInfo]", null, pageSize, pageIndex, fldSort, sort, strCondition, "ID", false, out pageCount, out count, out strSql);
            return GetList(ds);
        }
        #endregion
        ...
        /// 由一行数据得到一个实体
        /// </summary>
        private Hi.Model.BD_DisPriceInfo GetModel(DataRow r)
        {
            Hi.Model.BD_DisPriceInfo model = new Hi.Model.BD_DisPriceInfo();
            model.ID = SqlHelper.GetInt(r["ID"]);
            model.DisPriceID = SqlHelper.GetInt(r["DisPriceID"]);
