...
namespace Hi.SQLServerDAL
{
    ...
    public partial class SYS_Role
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Hi.Model.SYS_Role model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Hi.Model.SYS_Role model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetMaxId()
        {
            return SqlHelper.GetMaxID(SqlHelper.LocalSqlServer, "[ID]", "[SYS_Role]");
        }
        ...
        /// 得到一个对象实体
        /// </summary>
        public Hi.Model.SYS_Role GetModel(int ID)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// </summary>
        public IList<Hi.Model.SYS_Role> GetList(string strSql)
        {
        ...
        public DataSet GetDataSet(string strWhat, string strWhere, string strOrderby, System.Data.SqlClient.SqlTransaction Tran=null)
        {
            if (string.IsNullOrEmpty(strWhat))
                strWhat = "*";
            StringBuilder strSql = new StringBuilder("select " + strWhat + " from [SYS_Role]");
        ...
        /// 获取泛型数据列表,在单表查询时使用
        /// </summary>
        public IList<Hi.Model.SYS_Role> GetList(string strWhat, string strWhere, string strOrderby, System.Data.SqlClient.SqlTransaction Tran)
        {
        ...
        /// 分页获取泛型数据列表
        /// </summary>
        public IList<Hi.Model.SYS_Role> GetList(int pageSize, int pageIndex, string fldSort, bool sort, string strCondition, out int pageCount, out int count)
        {
            string strSql;
            DataSet ds = SqlHelper.PageList(SqlHelper.LocalSqlServer, "[SYS_Role]", null, pageSize, pageIndex, fldSort, sort, strCondition, "ID", false, out pageCount, out count, out strSql);
            return GetList(ds);
        }
        #endregion
        ...
        /// 由一行数据得到一个实体
        /// </summary>
        private Hi.Model.SYS_Role GetModel(DataRow r)
        {
            Hi.Model.SYS_Role model = new Hi.Model.SYS_Role();
            model.ID = SqlHelper.GetInt(r["ID"]);
            model.CompID = SqlHelper.GetInt(r["CompID"]);
            model.DisID = SqlHelper.GetInt(r["DisID"]);
            model.RoleName = SqlHelper.GetString(r["RoleName"]);
        ...
        /// 由数据集得到泛型数据列表
        /// </summary>
        private IList<Hi.Model.SYS_Role> GetList(DataSet ds)
        {
            return Common.GetListEntity<Hi.Model.SYS_Role>(ds.Tables[0]);
        }
    }
}
