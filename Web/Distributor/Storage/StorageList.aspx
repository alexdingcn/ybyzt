<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StorageList.aspx.cs" Inherits="Distributor_Storage_StorageList" 
%>
        ...
        <div class="w1200">
            ...
            <div class="rightCon">
                <div class="info"><a id="navigation1" href="/Distributor/UserIndex.aspx">我的桌面</a>>
                    <a id="navigation2" href="/Storage/StorageList.aspx" class="cur">入库单列表</a>
                </div>

                <!--功能条件 start-->
                <div class="userFun">
                    <div class="left">
                        <a href="/Distributor/Storage/StorageAdd.aspx" class="btnOr" id="btnAdd" runat="server"><i class="addIcon"></i>新建入库单</a>
                    </div>
                    <div class="right">
                        <ul class="term">
                ...
                <div class="hidden userFun" style=" text-align:right; padding-right:160px; padding-top:10px; display:none;">
                     <div class="right">
                        <ul class="term">
                                <li><label class="head">日期:</label><input name="txtCreateDate" runat="server" onclick="var endDate=$dp.$('txtEndCreateDate'); WdatePicker({onpicked:function(){endDate.focus();},maxDate:'#F{$dp.$D(\'txtEndCreateDate\')}'})"
                            ...
                            <ItemTemplate>
                                <tr id='tr_<%# Eval("Id") %>'>
                                   <td>
                                    ...
                                    <td>
                                        <%# Eval("StorageDate","{0:yyyy-MM-dd}")%>
                                    </td>
                                    <td>
                                        <%# Eval("StorageType").ToString() == "1" ? "采购入库" : "其他入库"%>    
                                    </td>
                                    <td>
                                        <%# Eval("IState").ToString().ToInt(0) == 0 ? "新增" :  "审核"%>
                                    </td>
                                    <td>
                                        <a href="StorageInfo.aspx?KeyID=<%# Eval("Id") %>">详情</a>
                                    </td>
                                </tr>
                            </ItemTemplate>
                            <FooterTemplate>
