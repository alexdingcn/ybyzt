<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LibraryList.aspx.cs" Inherits="Distributor_Storage_LibraryList" %>
        ...
        <div class="w1200">
            ...
            <div class="rightCon">
                <div class="info">
                    ...
                    <a id="navigation2" href="/Storage/LibraryList.aspx" class="cur">出库单列表</a>
                </div>

                <!--功能条件 start-->
                <div class="userFun">
                    <div class="left">
                        <a href="/Distributor/Storage/LibraryAdd.aspx" class="btnOr" id="btnAdd" runat="server"><i class="addIcon"></i>新建出库单</a>
                    </div>
                    <div class="right">
                        <ul class="term">
                            <li>
                                <label class="head">单号:</label><input name="txtLibraryNO" type="text" id="txtLibraryNO" runat="server" class="box" maxlength="50" /></li>
                            <li>
                        ...
                        <asp:Repeater ID="rptOrder" runat="server">
                            ...
                            <ItemTemplate>
                                <tr id='tr_<%# Eval("Id") %>'>
                                    ...
                                    <td>
                                        <a href="LibraryInfo.aspx?KeyID=<%# Eval("Id") %>">详情</a>
                                    </td>
                                </tr>
                            </ItemTemplate>
                            <FooterTemplate>
