<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GoodsStorageList.aspx.cs"
    Inherits="Distributor_Storage_GoodsStorageList" %>
    ...
    <div class="w1200">
        ...
        <div class="rightCon">
            <div class="info"><a id="navigation1" href="/Distributor/UserIndex.aspx">我的桌面</a>>
                    <a id="navigation2" href="../Storage/GoodsStorageList.aspx" class="cur">商品库存</a></div>
                ...
                <table class="PublicList list" id="orderBg" border="0" cellspacing="0" cellpadding="0">
                    <asp:Repeater ID="rptOrder" runat="server">
                        ...
                        <ItemTemplate>
                            <tr id='tr_<%# Eval("Id") %>'>
                               <%--<td>
                                    <%# Eval("GoodsCode").ToString()=="0"?"":Eval("GoodsCode") %>
                               </td>--%>
                                <td>
                                    <%# Eval("GoodsName")%>
                                </td>
