<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectLibraryList.aspx.cs"
...
<body>
    <form id="form1" runat="server">
        ...
        <input type="hidden" id="hidhtId" runat="server" />
        ...
        <div class="rightinfo" style="width: 1000px; margin: 0 auto; margin-top: 10px;">
            ...
            <div class="tools">
                ...
                <div class="right">
                    ...
                    <ul class="toolbar3">
                        <li>
                            <label class="head">医院:</label><asp:DropDownList ID="HtDrop" runat="server" CssClass="box1" style="height: 26px" maxlength="50"></asp:DropDownList>
                        </li>
                        <li>
                    ...
                    <asp:Repeater runat="server" ID="rptOrder">
                        <ItemTemplate>
                            <tr id='tr_<%# Eval("Id") %>'>
                                ...
                                <td>
                                    <div class="tc">
                                        <%# Convert.ToDecimal( Eval("OutNum")).ToString("#0")%>
                                    </div>
                                </td>
                                <td>
                                    <div class="tc">
                                        <%#Convert.ToDecimal( Eval("AuditAmount")).ToString("#0.00")%>
                                    </div>
                                </td>
                                <td>
                                    <div class="tc">
                                        <%#Convert.ToDecimal( Eval("sumAmount")).ToString("#0.00")%>
                                    </div>
                                </td>
                            </tr>
                        </ItemTemplate>
