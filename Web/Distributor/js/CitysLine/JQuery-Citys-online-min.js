...
function Change2() {
    ...
    if($("#hidProvince").val()=="北京市" || $("#hidProvince").val() == "上海市" || $("#hidProvince").val() == "天津市" || $("#hidProvince").val() == "重庆市") {
        $("#lbladdr1").text(provchange + distchange).css("display", "block");
    }
    else {
        $("#lbladdr1").text(provchange + citychange + distchange).css("display", "block");
    }
    if ($("#hidProvince").val() == "选择省") {
        $("#lbladdr1").text("");
    }
}
...
function Change4() {
    ...
    if ($("#hidProvince").val() == "北京市" || $("#hidProvince").val() == "上海市" || $("#hidProvince").val() == "天津市" || $("#hidProvince").val() == "重庆市") {
        $("#txtAddress").val(provchange + distchange);
    }
    else {
        $("#txtAddress").val(provchange + citychange + distchange);
    }
