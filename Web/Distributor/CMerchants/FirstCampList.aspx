<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FirstCampList.aspx.cs"
    Inherits="Distributor_CMerchants_FirstCampList" %>
    ...
    <div class="w1200">
        ...
        <div class="rightCon">
            <div class="info"><a id="navigation1" href="/Distributor/UserIndex.aspx">我的桌面</a>>
                    <a id="navigation2" href="/CMerchants/CMerchantsList.aspx" class="cur">首营列表</a></div>
                        ...
                        <ItemTemplate>
                            <tr id='tr_<%# Eval("Id") %>'>
                               <td>
                                ...
                                <td>
                                    <%# Eval("State").ToString().ToInt(0) == 0 ? "申请" : Eval("State").ToString().ToInt(0) == 1 ? "<i style=\"color:#ff0000;\">驳回</i>" : "<i style=\"color:#00DB00;\">通过</i>"%>
                                </td>
                                <td>
