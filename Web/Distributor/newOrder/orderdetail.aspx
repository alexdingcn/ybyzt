<%@ Page Language="C#" AutoEventWireup="true" CodeFile="orderdetail.aspx.cs" Inherits="Distributor_newOrder_orderdetail" %>
...
<head runat="server">
    ...
    <script src="../../Company/js/js.js?v=<%=ConfigCommon.GetNodeValue("Version.xml","Version")%>" type="text/javascript"></script>
    <script src="js/order.js?v=<%=ConfigCommon.GetNodeValue("Version.xml","Version")%>" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        //支付流水，跳转到详情页面
        function PayItem(orderid,paymentid) {
            window.location.href = '../Rep/PayOrderInfo.aspx?RepDetailsList&orderid=' + orderid + '&Paymnetid=' + paymentid + '&KeyID=' + paymentid;

        }
        
        //支付流水打印回单
        function PayItemPrint(paymentid) {
            var url = '../PayPrint/PayInfoPrint.aspx?KeyId=' + paymentid;      //转向网页的地址; 
...
<body>
    ...
    <!--头部 end-->
    <input  type="hidden" runat="server" id="hid_type" value="0" />
    ...
    <div class="rightCon">
        <div class="info">
            <a id="navigation1" href="../UserIndex.aspx">我的桌面</a>> <a id="navigation2" runat="server" href="../OrderList.aspx">
                订单列表</a>> <a id="navigation3" href="#">订单详情</a>
        </div>
        ...
        <div class="goods-zs">
            ...
            <ul class="goods-title">
                ...
                <li tip="2"><a href="javascript:;">收货</a></li>
                <li tip="3"><a href="javascript:;">付款</a></li>
            </ul>
            <input type="hidden" id="hidDigits" runat="server" value="0" />
            <div class="blank10">
            </div>
            <!--标题 end -->
            <!--订单 start -->
                ...
                <div class="goods-if">
                    ...
                    <div class="alink">
                        ...
                        <label id="modifyorder" runat="server">
                            <a href="orderBuy.aspx?KeyID=<%=Common.DesEncrypt(KeyID.ToString(),Common.EncryptKey) %>" class="bule">订单修改</a>|</label>
                        <label id="ordervoid" runat="server">
                            <a href="javascript:;" class="bule">订单作废</a>|</label>
                        <%--<label id="orderReturn" runat="server">
                            <a href="javascript:;" class="bule">退货申请</a>|</label>--%>
                                    ...
                                    <tr trd="<%# Eval("ID") %>">
                                        ...
                                        <td>
                                            <div class="sPic">
                                                ...
                                                <a target="_blank" href="/Distributor/GoodsInfo.aspx?goodsId=<%# Eval("GoodsID") %>&goodsInfoId=<%# Eval("GoodsInfoID") %>" class="name">
                                                ...
                                                <a target="_blank" href="../GoodsInfo.aspx?goodsId=<%# Eval("GoodsID") %>&goodsInfoId=<%# Eval("GoodsInfoID") %>" class="name">
                                                    <%# Common.MySubstring(Convert.ToString(Eval("GoodsName")),20,"...")%><i><%# Eval("GoodsName")%></i></a>
                                                         <% } %>
                            ...
                            <asp:Repeater runat="server" ID="rptIsout">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="tc">
                                                <%# SelectGoodsInfo.GetNum((Convert.ToDecimal(Eval("GoodsNum")) + Eval("ProNum").ToString().ToDecimal(0) - Convert.ToDecimal(Eval("OutNum"))).ToString(), Digits)%>&nbsp;</div>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
                ...
                <div class="offLine " style="display: none;">
                    ...
                    <div class="li">
                        ...
                        <input name="txtArriveDate"  runat="server" onclick="WdatePicker({minDate:'%y-%M-%d'})" id="txtArriveDate"
                            readonly="readonly" type="text" class="box" />
                    </div>
                    <div class="li liw">
                        <div class="bt">
                            备 注：</div>
                   ...
                   <%-- 附件凭证上传  start--%>
                    ...
                    <div class="li liw">
                       ...
                       <div class="addDoc">
                             <a href="javascript:;" class="a-upload bule"> <input type="file" name="AddOrderfile" id="AddOrderfile" class="AddBanner" />+新增附件 </a>
                            ...
                            <ItemTemplate>
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="tc">
                                             <a href="javascript:void(0)" onclick='Go_disPayInfo("<%# Common.DesEncrypt(Eval("paymentID").ToString(), Common.EncryptKey) %>","<%# Common.DesEncrypt(Eval("PreType").ToString(), Common.EncryptKey) %>","<%=Common.DesEncrypt(KeyID.ToString(), Common.EncryptKey) %>")'>
                                                 <%# Eval("guids")%></a>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                             <div class="tc">
                                                 <a href="javascript:void(0)" style="color:Green;" onclick='PayItemPrint("<%# Common.DesEncrypt(Eval("paymentID").ToString(), Common.EncryptKey) %>")'>
                                                 <%# (Eval("PayType").ToString() == "快捷支付" || Eval("PayType").ToString() == "网银支付") ? "打印回单" : "" %></a>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
