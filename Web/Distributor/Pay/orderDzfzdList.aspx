<%@ Page Language="C#" AutoEventWireup="true" CodeFile="orderDzfzdList.aspx.cs" Inherits="Distributor_Pay_orderDzfzdList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function info(Id) {
            window.location.href = '../OrderZDInfo.aspx?KeyID=' + Id + '&type1=orderDzfzdList';
        }
    </script>
</head>
<body class="root3">
    <form id="form1" runat="server">
        ...
        <div class="w1200">
        <Left:Left ID="Left1" runat="server" ShowID="orderDzfzdList" />
        <div class="rightCon">
        <div class="info"> <a id="navigation1" href="/Distributor/UserIndex.aspx">我的桌面</a>>
                <a id="navigation2" href="#" class="cur">待支付账单</a>
            </div>
	        <!--功能条件 start-->
	        <div class="userFun">
                <div class="left">
