...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function submitPay(action) {<%--“立即支付”按钮onclick方法 --%>
            var KeyID = '<%= Request.QueryString["KeyID"] %>'; <%--订单ID --%>
...
<body class="root3">
   ...
   <%-- 隐藏域  end  --%>
    ...
    <div class="payInfo">
        <div class="number">
            订单号：<a href="javascript:void(0)" id="lblOrderNO" runat="server"></a></div>
        <div class="gray">
            您的订单已经确认，请及时支付。</div>
        <ul class="amount">
            <li class="ab">本次支付金额：<b class="money"><input id="txtPayOrder" runat="server" onkeyup="priceKeyup(this)"
                type="text" class="box1" /></b>元&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
            <li>未付款金额：<b class="price"
                runat="server" id="lblPricePay"></b>元 |&nbsp;订单总金额：<b class="price" runat="server" id="lblPriceO"></b>元 </li>
        </ul>
    </div>
    <%--支付信息 end--%>
    <div class="payOpt" id="checkId">
       ...
       其他平台支付 start
        <%if (Common.GetPayWxandAli(this.CompID).ali_isno == "1" || Common.GetPayWxandAli(this.CompID).wx_Isno == "1")
          {%> --%>
        <div class="li" id="a5" style="display:none;">
