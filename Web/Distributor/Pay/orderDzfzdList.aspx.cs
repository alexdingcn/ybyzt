...
public partial class Distributor_Pay_orderDzfzdList :DisPageBase
{
    ...
    public void Bind()
    {
        ...
        //该代理商的，没有删除标准的订单
        strwhere += " and Otype=9 and PayState in (0,1)  and OState<>6   and DisID='" + disid + "' and ReturnState in(0,1) and isnull(dr,0)=0"; //IsDel=1  订单已删除
