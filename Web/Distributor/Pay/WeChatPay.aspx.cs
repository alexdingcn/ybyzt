...
public partial class Distributor_Pay_WeChatPay : DisPageBase
{
    ...
    public void GetUrl(string oid, decimal payprice)
    {
        ...
        string[] json = Tx1401.tx1401("10", oid, payprice);
        //生成成功
    ...
    {
        Response.Redirect("Error.aspx?type=" + Common.DesEncrypt("3", Common.EncryptKey) + "&KeyID=" + Common.DesEncrypt(orderid, Common.EncryptKey) + "&msg=" + Common.DesEncrypt(msg, Common.EncryptKey), false);
    }
}
