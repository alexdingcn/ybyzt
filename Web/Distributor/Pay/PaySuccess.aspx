        ...
        function myfunction(wait) {
            if (wait > 0) {
                ...
                //window.location.href = " ../OrderInfo.aspx?KeyID=<%= Common.DesEncrypt(KeyID.ToString(),Common.EncryptKey) %>";
                 "<%=Type %>" == "3" ? window.location.href = "PrePayList.aspx" : "<%=Type %>" == "2" ? window.location.href = "orderZDList.aspx" : window.location.href = " ../neworder/orderdetail.aspx?KeyID=<%= Common.DesEncrypt(KeyID.ToString(),Common.EncryptKey) %>"; 
                //"<%=Type %>" == "3" ? window.location.href = "PrePayList.aspx" : window.location.href = " ../neworder/orderdetail.aspx?KeyID=<%= Common.DesEncrypt(KeyID.ToString(),Common.EncryptKey) %>";              
            }
        }
...
<body onload="myfunction(5)" class="root3">
    ...
    <div class="payOpt" id="checkId">
        <div class="payOk">
            <img src="../images/ok.png" /><%=str %><i class="red"><span id="PayedAmount" runat="server"></span></i>元</div>
        <div class="payLink">
           <%=url %></div>
