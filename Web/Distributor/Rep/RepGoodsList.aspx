<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RepGoodsList.aspx.cs" Inherits="Distributor_Rep_RepGoodsList" %>
...
<body class="root3">
    ...
    <div class="info"><a id="navigation1" href="/Distributor/UserIndex.aspx">我的桌面</a>>
                    <a id="navigation2" href="/Distributor/RepGoodsList.aspx" class="cur">商品进货数据</a></div>
        <!--功能条件 start-->
        <div class="userFun">
            <div class="left">
                </div>
            <div class="right">
                <ul class="term">
                    ...
                    <li>
                         <label class="head">商品分类：</label>
                         <input id="txtCategory" runat="server" type="text" class="box" style=" width:110px;" />
                    </li>
                </ul>
                <a id="A1" href="#" class="btnBl" onserverclick="A_Seek" runat="server"><i class="searchIcon"></i>搜索</a>
                <a href="javascript:void(0);" onclick="javascript:location.href='RepGoodsList.aspx'" class="btnBl"><i class="resetIcon"></i>重置</a>
                ...
                <asp:Repeater ID="rptOrder" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                           ...
                           <%-- <td>
                                <%# Eval("goodsCode").ToString()%>&nbsp;
                            </td>--%>
                            <td>
                                 <%# Eval("categoryName").ToString()%>&nbsp;
                            </td>
                            <td>
                                 <%# Eval("goodsNum") == DBNull.Value ? 0 : decimal.Parse(string.Format("{0:N4}", Convert.ToDecimal(Eval("goodsNum")).ToString("#,####" + Digits)))%>&nbsp;
                            </td>
                            <td>
