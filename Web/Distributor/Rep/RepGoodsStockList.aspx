<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RepGoodsStockList.aspx.cs"
    Inherits="Distributor_Rep_RepGoodsStockList" %>
    ...
    <div class="w1200">
        ...
        <div class="rightCon">
            <div class="info"><a id="navigation1" href="/Distributor/UserIndex.aspx">我的桌面</a>>
                    <a id="navigation2" href="../Rep/GoodsStorageList.aspx" class="cur">库存报表</a></div>
