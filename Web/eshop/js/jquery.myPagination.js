    ...
    function init(param, obj) {
        if (param && param instanceof Object) {
            ...
            function updateView() {
                ...
                content += getFirst();
                if (currPage == 1) {
                    content += "<span class=\"s-icon2 preNo\" title=\"" + getPrev() + "\"> </span>"
                    //  content += "<span class=\"preNo\" title=\"" + getPrev() + "\">" + getPrev() + " </span>"
                } else {
                    content += " <a href=\"" + link + "\" class=\"s-icon2 pre\"  title='" + (currPage - 1) + "'></a>"
                    // content += " <a href='" + link + "' class='pre' title='" + (currPage - 1) + "'>" + getPrev() + " </a>"
                }
                if (firstPage <= 0) {
                    firstPage = 1
                }
                ...
                //                        content += "<span class=\"sel\" title=\"" + firstPage + "\">" + firstPage + "</span>"
                //                    } else {
                //                        content += "<a href='" + link + "' class='dft_a' title='" + firstPage + "'>" + firstPage + "</a>"
                //                    }
                //                }
                if (currPage == pageCount) {

                    content += "<span class=\"nextNo x-icon2\" title=\"" + getNext() + "\"></span>"
                    // content += "<span class=\"nextNo\" title=\"" + getNext() + "\">" + getNext() + " </span>"
                } else {
                    content += "<a href='" + link + "' class='next x-icon2' title='" + (currPage + 1) + "'></a>"
                    // content += "<a href='" + link + "' class='next' title='" + (currPage + 1) + "'>" + getNext() + " </a>"
                }
