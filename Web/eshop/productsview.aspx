...
<body class="root">
    ...
    <div class="whiteBg w1200">
        ...
        <div class="spDetails">
            ...
            <div class="dPic left" style="display: none">
                <img src="../images/Goods400x400.jpg" width="350" height="350" alt="暂无图片" /></div>
            ...
            <div class="sp-deta left">
                <h2 class="title" id="lblGoodsName" runat="server">
                    <div class="sale-box">
                        <i class="sale">促销</i></div>
                </h2>
                <label id="lblGoodsTitle" class="txt" runat="server">
                </label>
                <div style="height: 50px; line-height: 50px; padding-left: 5px;">
                    <i>商品编码：</i><i id="lblCode" runat="server"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i>单位：</i><i id="lblunit" runat="server"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span  style='<%= OrderInfoType.rdoOrderAudit("商品是否启用库存",compId)=="0"?"": "display:none" %>'><i>库存：</i><i id="lblinventory" runat="server"></i></span></div>
                        ...
                        <div class="li">
                            ...
                            <div class="sl">
                                <a href="javsscript:;" class="minus">-</a><input type="text" class="box txtNum" value="1"
                                    style="height: 23px;" onkeyup="KeyInt(this);" /><a href="javsscript:;" class="add">+</a></div>
                        </div>
                    </div>
                </div>
                <div class="blank20">
                ...
                <div class="btn">
                    <a href="javascript:;" class="keep"><i class="sc-icon"></i>加入收藏</a><a href="javascript:;"
                        class="addCart"><i class="gwc-icon"></i>加入购物车</a><a href="javascript:;"
                            class="addReg" style="color: #fff;">申请合作</a></div>
            </div>
            <div class="recommend">
                <div class="title">
                    <h3>
    ...
    <div class="ad1200 w1200">
        <a href="javsscript:;">
            <img src="../images/ad1200.jpg" alt="暂无图片"></a></div>
    <div class="blank10">
    </div>
