...
public partial class EShop_UserControl_EshopHeader : System.Web.UI.UserControl
{
    ...
    public void IsLogin()
    {
        ...
        ImgBigCompQRCode.Src = ConfigurationManager.AppSettings["ImgViewPath"] + "CompImg/c" + Request["Comid"].Trim() + ".png";
        ImgSmCompQRCode.Src = ConfigurationManager.AppSettings["ImgViewPath"] + "CompImg/c" + Request["Comid"].Trim() + ".png";
        if (loginuser != null)
        {
