...
<body class="root">
    ...
    <div class="content">
        <form id="form2" runat="server">
            ...
            <div class="content-padded">
                <h2 id="lblGoodsName" runat="server"></h2>
                <h3 id="lblGoodsTitle" runat="server"></h3>
                <h3><%= hideInfo1 %></h3>
                <h3><%= hideInfo2 %></h3>
            </div>
            ...
            <div class="segmented-control">
                <a class="control-item active" href="#productdesc">商品介绍
                </a>
                <a class="control-item" href="#productcert">注册证
                </a>
            </div>
            <div class="card">
    ...
    <nav class="bar bar-tab">
          <a class="tab-item" href="/<%=Request["Comid"] %>.html">
            店铺首页
          </a>
          <a class="tab-item" href="/<%=Request["Comid"] %>.html#allPro">
            全部商品
          </a>
          <a class="tab-item" href="/eshop/about_<%=Request["Comid"] %>.html">
            公司介绍
          </a>
    </nav>
