...
public partial class jlc_login : System.Web.UI.Page
{
    ...
    protected void btnlogin_click(object sender, EventArgs e)
    {
        ...
        var password = this.txtpassword.Value.Trim();
        ...
        {
            string jsonUser = "{\"type\":\"1\",\"username\":\"" + this.txtuid.Value.Trim() + "\",\"password\":\"" + this.txtpassword.Value.Trim() + "\",\"logo\":\"\"}";

            user = new AESHelper(inKey).KeyEncrypt(jsonUser, out sign, out validity);

            string url = "../SSOLogin.aspx?user=" + user + "&sign=" + sign + "&valid=" + validity;

            this.aSSoLogin.Attributes.Add("href", url);
