...
///CompPageBase 的摘要说明
/// </summary>
public class DisPageBase : System.Web.UI.Page
{
    ...
    override protected void OnInit(EventArgs e)
    {
        ...
        try
        {
            ...
            //if ((TypeID != 1 && TypeID != 5) || DisID == 0 || UserID == 0)
            //{
            //    HttpContext.Current.Response.Redirect("~/login.html", true);
            //}
    ...
    void CompPageBase_Error(object sender, EventArgs e)
    {
        ...
        //Response.Redirect("~/Company/error.html?ErMSG=" + objErr.Message + "",true);
    }
