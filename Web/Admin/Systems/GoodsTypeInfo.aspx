<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GoodsTypeInfo.aspx.cs" Inherits="Admin_Systems_GoodsTypeInfo" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("li#libtnEdit").on("click", function () {
                location.href = "GoodsTypeModify.aspx?KeyID="+<%= Request.QueryString["KeyID"] %>;
            })
    ...
    <div class="m-place">
        ...
        <div class="tools">
            <ul class="toolbar left">
                ...
                <li id="lblbtnback" onclick="location.href = 'GoodsTypeList.aspx'"><span>
