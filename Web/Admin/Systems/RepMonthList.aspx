<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RepMonthList.aspx.cs" Inherits="Admin_Systems_RepMonthList" EnableEventValidation="false" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#li_Reset").click(function () {
                window.location.href = 'RepMonthList.aspx';
            });
        });
    </script>
</head>
<body>
    ...
    <div class="m-place">
            ...
            <a href="#">报表查询</a><i>></i>
            <a href="RepMonthList.aspx">销售数据月份变动</a>
        </div>
        <!--当前位置 end--> 
        <input type="hidden" id="salemanid" runat="server" />
        <input type="hidden" id="hid" runat="server" />
        <input type="hidden" id="aspx" runat="server" value="RepMonthList.aspx" />
        ...
        <asp:Button ID="btnSearch" Text="搜索" runat="server" onclick="btnSearch_Click" style=" display:none"  />
            ...
            <div class="tools">
                ...
                <div class="right">
                    <ul class="toolbar right">
                        ...
                        <uc1:ToExcel runat="server" ID="ToExcel" contect="TbRepMonthList" Visible="true" />
            ...
            <!--信息列表 start-->
                <asp:Repeater ID="rptOrder" runat="server">
                    <HeaderTemplate>
                        <table class="tablelist" id="TbRepMonthList">
                            <thead>
                                <tr>
                                    <th>月份</th>
                                    <th>厂商名称</th>
