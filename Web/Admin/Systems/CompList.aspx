<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CompList.aspx.cs" Inherits="Admin_Systems_CompList" EnableEventValidation="false" %>
     ...
     <script>
         ...
         $(document).ready(function () {
             ...
             $("li#libtnAdd").on("click", function () {
                 location.href = "CompEdit.aspx?type=1";
             })
            ...
            <a href="#">厂商维护</a>
                  ...
                  <div class="tools">
                     <ul class="toolbar left">
                          <li id="libtnAdd"><span><img src="../../Company/images/t01.png" /></span>新增企业</li>
                      </ul>
                    <div class="right">
           ...
           <table class="tablelist" id="TbDisList">
                ...
                <tbody>
                  <asp:Repeater ID="Rpt_Comp" runat="server">
                   <ItemTemplate>
                    <tr>
                         <td><a style=" text-decoration:underline; " href='CompInfo.aspx?KeyID=<%#Eval("Id") %>&type=2&page=<%=page %>' ><%# Eval("CompName")%><%# Eval("Erptype").ToString().ToInt(0) > 0 ? "&nbsp;(" + Enum.GetName(typeof(Enums.Erptype), Eval("Erptype").ToString().ToInt(0)) + ")" : ""%></a></td>
                         <td><%# Eval("Trade")%></td>
