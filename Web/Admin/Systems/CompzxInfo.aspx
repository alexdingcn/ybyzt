...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CompzxInfo.aspx.cs" EnableEventValidation="false" Inherits="Admin_Systems_CompzxInfo" %>
...
//            })
            ...
            $("li#liqxzx").on("click", function () {
                confirm("取消装修？", function () { $("#btnqxzx").trigger("click"); }, "提示");
            })


            $("li#lizxaudit").on("click", function () {
                confirm("装修审核？", function () { $("#btnzxaudit").trigger("click"); }, "提示");
            })
            $("li#liqxzxaudit").on("click", function () {
                confirm("取消装修审核？", function () { $("#btnqxzxaudit").trigger("click"); }, "提示");
            })
...
<body>
    ...
    <div class="m-place">
            ...
            <a href="#" runat="server" id="Atitle">厂商装修</a>
        </div>
        <%#Eval("IsEnabled")%>
                <div class="tools">
                    <ul class="toolbar left">
                         <li id="lizx" runat="server"><span><img src="../../Company/images/t17.png" runat="server" id="img4" /></span>确认装修</li>
                         <li id="liqxzx" runat="server"><span><img src="../../Company/images/t17.png" runat="server" id="qxzx" /></span>取消装修</li>
                         <li id="lizxaudit" runat="server"><span><img src="../../Company/images/t17.png" runat="server" id="img1" /></span>装修审核</li>
                         <li id="liqxzxaudit" runat="server"><span><img src="../../Company/images/t17.png" runat="server" id="img2" /></span>取消装修审核</li>
                      ...
                      <input type="button" runat="server" id="btnqxzx" onserverclick="btn_qxzx" style="display:none;"  />

                      <input type="button" runat="server" id="btnzxaudit" onserverclick="btn_zxaudit" style="display:none;"  />
                      <input type="button" runat="server" id="btnqxzxaudit" onserverclick="btn_qxzxaudit" style="display:none;"  />
                 </div>
                 ...
                 <%--<%# Eval("IsEnabled").ToString() == "1" ? "是" : "(style='color:red')"%> --%>
                     ...
                     <table  id="tab1" class="tb">
                       <tbody>
                        ...
                        <tr>
                            <td><span>是否已装修</span> </td>
                            <td><label runat="server" id="lblzx"></label> </td>  
                            <td ><span>装修已审核</span> </td>
                            <td ><label runat="server" id="lblzxaudit"></label> </td>       
                        </tr>
                        <tr>
                            <td><span>装修时间</span> </td>
                            <td><label runat="server" id="lblOrgzxdate"></label> </td>  
                            <td ><span>装修审核时间</span> </td>
                            <td ><label runat="server" id="lblZXAuditDate"></label> </td>       
                        </tr>
                         ...
                         <tr>
                          ...
                          <input runat="server" style="width:60px;" type="text" disabled="disabled" maxlength="50" class="textBox" id="txtSort" />&nbsp;&nbsp;
                          <%--<asp:ImageButton ID="btnSave" runat="server" ImageUrl="../../images/ToolsItemSave.gif"
                          BorderWidth="0" BorderStyle="None" AlternateText="保存" OnClick="btnSaveSort_click"></asp:ImageButton>--%>
                          <i class="grayTxt">（默认为999，升序排列）</i></td>
                         </tr>
                           <tr>
