<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserModify.aspx.cs" Inherits="Admin_Systems_UserModify"  EnableEventValidation="false"%>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" id="rdotype2" name="rdotype" runat="server"
                                value="2" checked="true"  />&nbsp;&nbsp;系统用户
                            <input type="radio" id="rdotype3" name="rdotype" runat="server"
                                value="2"   />&nbsp;&nbsp;机构业务员</i><i id="SalesManNames"></i>
                        </td>
                    </tr>
                    <tr>
                        <td>
