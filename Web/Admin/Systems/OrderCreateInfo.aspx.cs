...
public partial class Company_Order_OrderCreateInfo : AdminPageBase
{
    ...
    public void Bind()
    {
        ...
        if (OrderInfoModel != null)
        {
            ...
            this.lblOState.InnerText = OrderInfoType.OState(OrderInfoModel.OState);
            ...
            if (OrderInfoModel.OState == (int)Enums.OrderState.已审)
            {
                ...
                else
                {
                    ...
                    {
                        this.Clearing.Attributes.Add("style", "display:inline-block;");
                        this.PrePayMonery.Attributes.Add("style", "display:inline-block;");
    ...
    protected void btnAudit_Click(object sender, EventArgs e)
    {
        ...
        if (OrderInfoModel != null)
        {
            if (OrderInfoModel.OState == (int)Enums.OrderState.待审核)
            {
                string sql = " update [DIS_Order] set [OState]=" + (int)Enums.OrderState.已审 + " where ID=" + Id;
                if (OrderInfoBll.UpdateOrderState(sql))
                {
                    //Utils.AddSysBusinessLog(this.CompID, "Order", Id.ToString(), "审核", "");
                    Bind();
                }
            }
            else
