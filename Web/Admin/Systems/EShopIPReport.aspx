<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EShopIPReport.aspx.cs" Inherits="EShopLogReport" %>
...
<body>
    ...
    <div class="m-place">
            ...
            <a href="#">报表查询</a><i>></i>
            <a href="EShopLogReport.aspx">IP点击量查询</a>
    </div>
    <!--当前位置 end-->
        <!--功能按钮 start-->
        <div class="tools">
            ...
            <div class="right">
                ...
                <ul class="toolbar3">
                    ...
                    <li>IP地址:<input name="txtIPName" type="text" id="txtIPName" runat="server" class="textBox" />
                    </li>
                    <li>访问时间:
        ...
        906：116.231.114.154  &nbsp; &nbsp; &nbsp; &nbsp;    801、802：116.231.101.127
        <!--列表分页 start-->
