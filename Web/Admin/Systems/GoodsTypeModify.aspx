<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GoodsTypeModify.aspx.cs" Inherits="Admin_Systems_GoodsTypeModify" %>
...
<body>
    ...
    <div class="m-place">
           ...
           <a href="#">系统管理</a><i>></i>
           <a href="GoodsTypeList.aspx">商品分类管理</a>
    </div>
    <!--当前位置 end-->
        <div class="div_content">
            <table class="tb">
                <tbody>
                    <tr>
                        <td width="120">
                            <span><i class="required">*</i>商品分类名称</span>
                        </td>
                        <td>
                            <input type="text" id="txtGoodsName" runat="server" class="textBox" maxlength="50" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" id="txtSort" runat="server" class="textBox" maxlength="50" onkeyup="KeyInt(this);" onblur="KeyInt(this);" />
                        </td>
