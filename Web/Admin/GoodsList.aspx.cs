...
public partial class Company_ShopManager_GoodsList : AdminPageBase
{
    ...
    public void Bind()
    {
        ...
        int pageCount = 0;
        int Counts = 0;
        string strWhere = " and ISNULL(dr,0)=0 and ComPid=" + KeyID + " and GoodsName!='' and isoffline=1";
    ...
    private void Where()
    {
        ...
        //赋值
        string goodsName = Common.NoHTML(this.txtGoodsName.Value.Trim());//商品名称
        ...
        {
            string cateID = Common.CategoryId(Convert.ToInt32(hideID), KeyID);//商品分类递归
