<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RoleInfo.aspx.cs" Inherits="Admin_Role_RoleInfo" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("li#libtnAdd").on("click", function() {
                location.href = "UserModify.aspx?ntype=2&RoleID=" + <%= KeyID %>;
                //var index = layerCommon.openWindow('岗位人员新增', 'UserModify.aspx?ntype=2&RoleID='+<%= KeyID %>,);
                // $("#hid_Alert").val(index);
            });
            ...
            $("li#lblbtnback").on("click", function () {
                location.href = "../Systems/UserList.aspx?KeyID="+<%=KeyID%>;
            });
        ...
        //转到详细页
        function GoInfo(Id) {
            location.href = "../Systems/UserInfo.aspx?ntpye=1&RoleID=<%=KeyID%>&KeyID= "+ Id;
            //var index = layerCommon.openWindow('岗位人员详情', '../Systems/UserInfo.aspx?ntpye=1&KeyID=' + Id, '1016px', '350px');
            //$("#hid_Alert").val(index);
        }
    </script>
    <style>
...
<body>
   ...
   <uc1:Header ID="Header1" runat="server" />
    ...
    <div class="m-place">
            ...
            <a href="../Systems/UserList.aspx" runat="server" id="atitle">系统用户及权限</a><i>></i>
            <a href="#" runat="server" id="btitle">岗位权限维护详细</a>
     </div>
     <input type="hidden" id="hid_Alert" />
     <asp:Button ID="reload" runat="server" OnClick="reload_Click" Style="display: none;" />
           <div class="tools">
              <ul class="toolbar left">
                <li id="libtnallot"><span><img src="../../Company/images/t01.png" /></span><label>分配权限</label></li>
...
<%--            <li id="libtnUse" runat="server"><span><img src="../images/nlock.png" /></span>启用<input type="button" runat="server" id="btnUse" onserverclick="btn_Use" style="display:none;"  /></li>
                ...
                <li id="lblbtnback"><span><img src="../../Company/images/tp3.png" /></span>返回</li>
              </ul>
            </div>
               <div class="div_content">
                ...
                <div>
                     <div class="div_title" >
                         ...
                         <div class="tools">
                        <ul class="toolbar left">
                            <li id="libtnAdd"><span><img src="../../Company/images/t01.png" /></span>新增人员</li>
                        </ul>
                        </div>
                    <!--用户列表 start-->
                            ...
                            <asp:Repeater ID="rpDtl" runat="server" >
                                ...
                                <ItemTemplate>
                                    <tr class="list-title" style=" text-align:center;">
                                        ...
                                        <td><a style=" text-decoration:underline; " href="javascript:void(0)" onclick='GoInfo(<%# Eval("ID") %>);' ><%# Eval("LoginName")%></a></td>
                                        <td><%# Eval("TrueName")%></td>
                                        <td><%# Eval("Phone")%></td>
                                        <%--<td><%# Eval("Email")%></td>--%>
