...
public partial class Admin_Role_MenuEdit : AdminPageBase
{
    ...
    public void Bind()
    {
        IList<Hi.Model.SYS_SysFun> sysFuns = sysFunBLL.GetList("", " ParentCode = '' and Type=3", "SortIndex");
                ...
                if (MyRole != "")
                {
                    ...
                    if (arr.Length > 0)
                    {
                        ...
                        if (Request["nextstep"] + "" == "1")
                        {
                            ...
                            {
                                Response.Redirect("/Systems/UserList.aspx?nextstep=1");
                            }
                        }
                        else
                        {
                            ...
                            {
                                Response.Redirect("../Systems/UserList.aspx");
                            }
                        }
                        //}
                        //else
