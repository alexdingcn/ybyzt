<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ArrearageRpt.aspx.cs" Inherits="Company_Report_ArrearageRpt" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#li_Reset").click(function () {
                window.location.href = 'ArrearageRpt.aspx';
            });
        });
        //转到详细页
        function GotReturnInfo(Id) {
            ...
            var index = layerCommon.openWindow('订单详情', 'Pay.aspx?type=1&KeyID=' + Id + '&Sdate=' + sdate + '&Edate=' + edate, '900px', '450px');
            $("#hid_Alert").val(index);
        }
    </script>
</head>
        ...
        <div class="rightinfo">
            ...
            <div class="place">
	            <ul class="placeul">
                    ...
                    <li><a href="ArrearageRpt.aspx">代理商订单应收</a></li>
	            </ul>
            </div>
            <!--当前位置 end--> 
            <!--功能按钮 start-->
