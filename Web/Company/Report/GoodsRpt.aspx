<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GoodsRpt.aspx.cs" Inherits="Company_Report_GoodsRpt" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#li_Reset").click(function () {
                window.location.href = 'GoodsRpt.aspx';
            });
        });
    </script>
</head>
    ...
    <div class="rightinfo">
        ...
        <div class="place">
            <ul class="placeul">
                ...
                <li>></li>
                <li><a href="GoodsRpt.aspx">商品统计</a></li>
            </ul>
        </div>
        <!--当前位置 end-->
        <!--功能按钮 start-->
        ...
        <asp:Repeater ID="rptGoods" runat="server">
            ...
            <ItemTemplate>
                <tr id='tr_<%# Eval("GoodsinfoID") %>'>
                    <td>
                        <div class="tcle">
                            <%# getGoodsStr(Eval("GoodsinfoID").ToString() == "" ? Eval("GoodsinfoID2").ToString() : Eval("GoodsinfoID").ToString())%></div>
                    </td>
                    <td>
                        <div class="tc">
                            <%# Eval("num")%></div>
            ...
            <FooterTemplate>
                <tr id="trTotal" runat="server" visible='<%#bool.Parse((Pager.PageCount == Pager.CurrentPageIndex && rptGoods.Items.Count!=0).ToString())%>'>
                    <td>
                        <div class="tcle">
                    ...
                    <td>
                        <div class="tc">
                            <asp:Label ID="Label3" runat="server" Text="" Style="color: Red;"><%=string.Format("{0:N2}",te)  %></asp:Label></div>
                    </td>--%>
                </tr>
                </tbody> </table>
            </FooterTemplate>
