<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report2.aspx.cs" Inherits="Company_Report_Report2" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('iframe.ifrClass').load(function () {
                $('iframe.ifrClass').contents().find('.pullDown').css("width", "150px");
            });
        });
