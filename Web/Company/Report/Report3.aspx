<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report3.aspx.cs" Inherits="Company_Report_Report3" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#txtDisID").click(function () {
                ...
                //ChoseProductClass('/Company/UserControl/SelectDisList.aspx?lsScompid=' + Id, 0, 0);
                var height = document.body.clientHeight; //计算高度
                var layerOffsetY = (height - 450) / 2; //计算宽度
                var index = layerCommon.openWindow('选择代理商', '/Company/UserControl/SelectDisList.aspx?lsScompid=' + Id, '880px', '450px'); //记录弹出对象
