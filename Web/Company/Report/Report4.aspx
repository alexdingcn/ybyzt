<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report4.aspx.cs" Inherits="Company_Report_Report4" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#txtDisID").click(function () {
                ...
                var index = layerCommon.openWindow('选择代理商', '/Company/UserControl/SelectDisList.aspx?compid=' + Id, '880px', '450px', layerOffsetY); //记录弹出对象
