<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RepSaleList.aspx.cs" Inherits="Company_Report_RepSaleList" %>
    ...
    <div class="rightinfo">
        ...
        <div class="place">
            <ul class="placeul">
                ...
                <li>></li>
                <li><a href="RepSaleList.aspx">销售报表</a></li>
            </ul>
        </div>
        <!--当前位置 end-->
        <!--功能按钮 start-->
        <div class="tools">
            ...
            <div class="right">
                ...
                <ul class="toolbar3">
                    <li>商品:<input name="txtDisName" type="text" id="txtDisName" runat="server" class="textBox" />
                    </li>
        ...
        <asp:Repeater ID="rptOrder" runat="server">
            ...
            <ItemTemplate>
                <tr id='tr_<%# Eval("GoodsinfoID") %>'>
                    ...
                    <td>
                        <div class="tc">
                            <%# Convert.ToDecimal(Eval("GoodsPrice") == DBNull.Value ? 0 : Eval("GoodsPrice")).ToString("N")%></div>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
