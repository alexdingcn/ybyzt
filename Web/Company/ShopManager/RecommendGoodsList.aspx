<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RecommendGoodsList.aspx.cs"
    Inherits="Company_ShopManager_RecommendGoodsList" %>
    ...
    <div class="rightinfo">
        <div class="place">
            <ul class="placeul">
                ...
                <li><a href="RecommendGoodsList.aspx" runat="server" id="atitle">主推商品维护</a></li>
            </ul>
        </div>
        <!--广告区 start-->
        <div class="adbox">
