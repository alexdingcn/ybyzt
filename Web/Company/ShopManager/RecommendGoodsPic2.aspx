<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RecommendGoodsPic2.aspx.cs"
    Inherits="Company_ShopManager_RecommendGoodsPic2" %>
...
.place2
{
height: 30px;color: #fff;z-index: 999;background: #1d4a8d;border-left: 1px solid #103a78;position: fixed;top: 0;left: 0;right: 0;
    }
    .place2 a {
color: #fff;
cursor: default;
...
<body>
    ...
    <div class="place2" >
	        ...
	        <ul class="placeul">
                ...
                <li><a href="#" runat="server" id="Atitle">推荐商品</a></li>
	        </ul>
        </div>
    ...
    <div class="adbox">
        ...
        <div class="adImg" style="margin-top:82px;">
            ...
            <input type="file" id="upLoadImg1" name="upLoadImg" onchange="uploadAvatar(1);" style="width: 410px;
        ...
        <ul class="adImg2">
            <li>
                ...
                <input type="file" id="upLoadImg2" name="upLoadImg" onchange="uploadAvatar(2);" style="width: 180px;
            ...
            <li>
                <img src="../../Images/Goods400x400.jpg" id="imgAvatar3" runat="server" class="imgWrap"
                    style="cursor: pointer; width: 180px; height: 220px;" alt="图片" />
                <input type="file" id="upLoadImg3" name="upLoadImg" onchange="uploadAvatar(3);" style="width: 180px;
            ...
            <li style="margin-top:10px;">
                <img src="../../Images/Goods400x400.jpg" id="imgAvatar4" runat="server" class="imgWrap"
                    style="cursor: pointer; width: 180px; height: 220px;" alt="图片" />
                <input type="file" id="upLoadImg4" name="upLoadImg" onchange="uploadAvatar(4);" style="width: 180px;
                    height: 220px; cursor: pointer; float: left; margin: -220px 5px 0 0; opacity: 0;
                    filter: alpha(opacity=0); font-size: 40px" />
            ...
            <li style="margin-top:10px;">
                <img src="../../Images/Goods400x400.jpg" id="imgAvatar5" runat="server" class="imgWrap"
                    style="cursor: pointer; width: 180px; height: 220px;" alt="图片" />
                <input type="file" id="upLoadImg5" name="upLoadImg" onchange="uploadAvatar(5);" style="width: 180px;
                    height: 220px; cursor: pointer; float: left; margin: -220px 5px 0 0; opacity: 0;
                    filter: alpha(opacity=0); font-size: 40px" />
    ...
    <script>
        ...
        {
            type: "post",
            url: "../../Handler/HandleImg3.ashx",            //需要链接到服务器地址
            secureuri: false,
            fileElementId: "upLoadImg" + id,                        //文件选择框的id属性
            dataType: "text",
            //服务器返回的格式，可以是json
