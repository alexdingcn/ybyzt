...
public partial class Company_CMerchants_CMerchantsList : CompPageBase
{
    ...
    public void Bind()
    {
        int pageCount=0;
        int Counts=0;
        string strwhere = " and c.dr=0" + " and c.CompID=" + this.CompID;
        ...
        if (!string.IsNullOrWhiteSpace(disid)) {
            ...
            DataTable l = CMerchantsBll.getDataTable(Pager.PageSize, Pager.CurrentPageIndex,disid, strwhere, out pageCount, out Counts);
    ...
    public string Where()
    {
        ...
        if (this.txtCMName.Value.Trim() != "") {
            strWhere += " and c.CMName like '%" + this.txtCMName.Value.Trim() + "%'";
        }
        ...
        {
            strWhere += " and c.ForceDate>='" + this.txtCreateDate.Value.Trim().ToDateTime() + "'";
        }
        if (this.txtEndCreateDate.Value != "")
        {
            strWhere += "and c.ForceDate<'" + this.txtEndCreateDate.Value.Trim().ToDateTime().AddDays(1) + "'";
        }
