...
public class UploadHandler : System.Web.SessionState.IRequiresSessionState, IHttpHandler
{
    ...
    private void SaveFile(HttpContext context)
    {
        ...
        if (logUser != null)
        {
            string basePath = Common.GetWebConfigKey("ImgPath") + "PicSpace/" + logUser.CompID + "/";
            string name;
