...
function gengduo(indexs, goodsInfoId, goodsInfoIdList) {
    ...
    if (type=="1") {
        var index = layerCommon.openWindow("选择商品", "../../Distributor/newOrder/selectgoods.aspx?CompId=" + compId + "&index=" + indexs + "&goodsInfoId=" + goodsInfoId + "&type=1&goodsInfoIdList=" + goodsInfoIdList, "985px", "630px");  //记录弹出对象
    }
    else {
        var index = layerCommon.openWindow("选择商品", "../../Distributor/newOrder/selectgoods.aspx?CompId=" + compId + "&index=" + indexs + "&goodsInfoId=" + goodsInfoId + "&goodsInfoIdList=" + goodsInfoIdList, "985px", "630px");  //记录弹出对象
    }
