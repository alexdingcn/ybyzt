    ...
    <head runat="server">
        ...
        <style type="text/css">
            ...
            .tip4 {
	            ...
	            top: 20%;
	            left: 30%;
	            /*background:#fcfdfd;box-shadow:1px 8px 10px 1px #9b9b9b; border:8px solid rgba(0, 0, 0, .5); border-radius:5px;behavior:url(js/PIE.htc); display:none;*/
	            z-index: 111111;
            }
            ...
            <div class="rightinfo">
                ...
                <ul class="coreInfo">
                    <li class="lb fl"><i class="name"><i class="red">*</i>代理商名称</i>
                        <input type="text" class="box1" placeholder="2-20个汉字或字母，代理商公司名称" runat="server" onkeypress="KeyPress(event)" maxlength="50" id="txtDisName" />
                    </li>
                ...
                <!--账户信息 start-->
                <div class="c-n-title">账户信息 <small>（默认密码是123456）</small></div>
                <ul class="coreInfo">
                    <li class="lb fl"><i class="name"><i class="red">*</i>帐号</i>
                        <input runat="server" type="text" maxlength="50" class="box1" id="txtUsername" placeholder="2-20个文字、字母、数字，可以录入代理商姓名、简称等" />
                    </li>
                    ...
                    <li class="lb fl">
                        <i class="name"><i class="red">*</i>密码</i>
                        <asp:TextBox ID="txtUpwd" TextMode="Password" MaxLength="50" runat="server" CssClass="box1"></asp:TextBox>
                    </li>
                    <li class="lb fl">
                        <i class="name"><i class="red">*</i>确认密码</i>
                        <asp:TextBox ID="txtUpwds" TextMode="Password" MaxLength="50" runat="server" CssClass="box1"></asp:TextBox>
                    </li>
