<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TreeDisArea.aspx.cs" Inherits="Company_SysManager_TreeDisArea" %>
    ...
    <script type="text/javascript">
        ...
        function CloseTree(event, treeId, treeNode) {
            if (treeNode != "" && treeNode != null) {
                ...
                window.parent.CloseProductClassArea(treeNode.id, treeNode.name);
            }
        }
        ...
        function close1() {
            window.parent.AreaClose();
        }
        function celar() {
            window.parent.Areacelar();
        }
        //加载树
        function reloadTree() {
...
<body>
    ...
    <div style=" position:relative; height:200px;">
        ...
        <div  style=" position:fixed; left:0px; right:0px; bottom:0px;">
                    <input  type="button" class="tablelink"  onclick="celar();"  value="清除" />
                    <input  type="button" class="cancel"  onclick="close1();"  value="关闭" />
               </div>
    </div>
    </form>
</body>
