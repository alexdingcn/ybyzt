<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GoodsAreaList.aspx.cs" Inherits="Company_GoodsNew_GoodsAreaList" %>
...
<head id="Head1" runat="server">
    ...
    <script>
        ...
        //新增
        function addData() {
            location.href = "GoodsAreaEdit.aspx";
        }
        //删除
    ...
    <div class="rightinfo">
        ...
        <div class="tools">
            ...
            <div class="right">
                ...
                <ul class="toolbar3">
                    <li style="display:none">代理商区域:<uc1:TreeDisArea runat="server" ID="txtDisAreaBox" />
                    </li>
                    <li>代理商名称:<input name="txtDisName" type="text" id="txtDisName" runat="server" class="textBox txtDisName"
                        style="width: 90px" />
                    </li>
                    <li>商品分类:
                    ...
                    <li>商品名称:<input name="txtGoodsName" type="text" id="txtGoodsName" runat="server"
                        class="textBox txtGoodsName" style="width: 90px" /></li>
                ...
                <asp:Repeater ID="rptGoodsAreas" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <div class="tcle">  <%#  Common.GetDis(Convert.ToInt32(Eval("disId") == null ? 0 : Eval("disId")), "disname")%></div>
                            </td>
        ...
        <div class="pagin">
            <webdiyer:AspNetPager ID="Pager" runat="server" EnableTheming="true" PageIndexBoxType="TextBox"
                ...
                ShowCustomInfoSection="Left" CustomInfoHTML="共%PageCount%页，当前第%CurrentPageIndex%页，每页%PageSize%条 共%RecordCount%条"
                CssClass="paginList" CurrentPageButtonClass="paginItem" NumericButtonCount="6"
