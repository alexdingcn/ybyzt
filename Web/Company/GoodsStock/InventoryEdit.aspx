                        ...
                        <asp:Repeater ID="Repeater1" runat="server">
                           ...
                           <tr trindex="<%#Eval("ID")%>" trindex2="<%#Eval("ID")%>" id="<%#Eval("GoodsID") %>" tip="<%#Eval("GoodsinfoID") %>">
                               ...
                               <td>
                                   ...
                                   <span>
                                       <a onclick="return false;" target="_blank" href="../../e<%# Eval("GoodsInfoID") %>_<%=this.CompID %>_.html"><img src="<%# Common.GetPicURL(Eval("pic").ToString(), "resize200") %>" width="60" height="60"></a>
                                   </span>
