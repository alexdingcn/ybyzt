<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PayCreateView.aspx.cs" Inherits="Company_Pay_PayCreateView" %>
        ...
        <div class="rightinfo">
            ...
            <div class="tools">
                <div class="left">
                    ...
                    <ul class="toolbar3">
                        <li>入账时间:&nbsp;&nbsp;<asp:TextBox ID="txtArriveDateRegion" Style="width: 100px;" runat="server" class="Wdate" onFocus="WdatePicker({isShowWeek:true,onpicked:function() {$dp.$('ReporDays').value=$dp.cal.getP('W','W');$dp.$('HiddenField_Days').value=$dp.cal.getP('W','W');}})"></asp:TextBox></li>
                    </ul>
                    <ul class="toolbar3">
                        <li>流水帐号:<input name="" type="text" class="textBox"/></li>
                    </ul>
                </div>
            </div>
            <!--功能按钮 end-->
