<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WeChatPay.aspx.cs" Inherits="Distributor_Pay_WeChatPay" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
<title><%= ConfigurationManager.AppSettings["PhoneSendName"].ToString()%>支付平台</title>
    <link href="../../Distributor/css/pay.css" rel="stylesheet" />
     ...
     <script type="text/javascript">
         ...
         function time(wait) {//计时器
             if (wait >0) {
                 ...
                 var hidppid = $("#hidppid").val();

                 $.ajax({
                     type: 'POST',
                     url: "../../Handler/BehindWxPay.ashx",
                     async: false,
                     data: { hidguid: hidguid, hidprice: hidprice, hidordid: hidordid, hidpid: hidpid, hidppid: hidppid },
...
<input type="hidden" id="hidppid" runat="server" />
...
<!--header start-->
    <div class="header">
        <div class="con">
            ...
            <div class="topMenu">
                <a href="../jsc.aspx">我的桌面</a>|<a href="../../index.aspx">医站通首页</a>
                &nbsp;
...
<div class="pay-wechat">
	...
	<div class="wechat-p">
   <asp:Image ID="Image" runat="server" Width="300"/>
    <%-- <img src="../images/wechat.jpg" width="300" /></div>--%>
	<div class="tis"><i class="sm-i"></i><i class="t">请使用微信扫一扫<br />扫描二维码支付</i></div>
    <div class="app-p"></div>
    <div class=" clear"></div>
    </div> 
</div>
