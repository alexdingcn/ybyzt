...
public partial class Company_Pay_PayCreateDetails : CompPageBase
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            strWhere += " and  vdef3 like '%" + this.ddltype.Value + "%'";
        }
        ...
        //if(this.ddldisname.Value!="-1")
        //{
        //    strWhere += " and disid  =" + this.ddldisname.Value ;
        //}
