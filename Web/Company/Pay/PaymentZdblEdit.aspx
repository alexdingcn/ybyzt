<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaymentZdblEdit.aspx.cs" Inherits="Company_Pay_PaymentZdblEdit" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function formCheck() {
            ...
            var txtremark =stripscript($("#txtRemark").val());
...
<body>
    ...
    <div class="place">
        <ul class="placeul">
            ...
            <li><a href="PayCreateDetails.aspx">账单收款补录</a></li>
        </ul>
    </div>
    ...
    <!--当前位置 end-->
        <div class="div_content">
                ...
                <table class="dh">
                    <tr>
                        ...
                        <td style="width: 15%;">
                            <span>
                                <label style="color: Red; display: inline-block;">
                                    <i class="required">*</i></label>&nbsp;对应账单</span>
                        </td>
                        <td style="width: 30%;">
                    ...
                    <tr>
                        ...
                        <td>
                            <select id="ddltype" runat="server" class="select" style="width: 172px; margin-left: 5px;">
            ...
            <div class="footerBtn">
                ...
                <input name="" type="button" onclick="javascript:window.location.href = 'PayZdblList.aspx';" class="cancel"
                    value="返回" />
            </div>
        </div>
    </div>
