<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PayCreateDetails.aspx.cs"    Inherits="Company_Pay_PayCreateDetails" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#li_Reset").click(function () {
                window.location.href = 'PayCreateDetails.aspx';
            });
            //新增按钮事件
            $("#btnAdd").click(function () {
                //$(".tip").fadeIn(200);
                window.location.href = 'PayCreateAdd.aspx';
            });
    ...
    <!--补录明细审核 End-->
        ...
        <div class="tools">
            ...
            <div class="right">
                ...
                <ul class="toolbar3">
                    ...
                    <li>入账时间:<input name="txtArriveDate" runat="server" onclick="WdatePicker()" id="txtPayCreateDate"
                        readonly="readonly" type="text" class="Wdate" value="" />
                        -
                        <input name="txtPayEnddate" runat="server" onclick="WdatePicker()" id="txtPayEnddate"
                            readonly="readonly" type="text" class="Wdate" value="" />
                    </li>
                </ul>
            </div>
        ...
        <div class="hidden">
            <ul style="width: 90%;">
                ...
                <li>预收款来源:
                        <select id="ddltype" runat="server" class="downBox">
            ...
            <asp:Repeater runat="server" ID="rptPay">
                ...
                <ItemTemplate>
                    <tbody>
                        <tr>
                            <td>
                                <a style=" text-decoration:underline;" href="javascript:void(0)" onclick='goInfo(<%# Eval("ID") %>)'>
                                    <%# Eval("ID")%>
                                </a>
                            </td>
                            <td>
                            ...
                            <td>
                                <%#  Common.GetStr(Convert.ToString(Eval("vdef1")))%>
                            </td>
