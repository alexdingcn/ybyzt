...
public partial class Company_Pay_PaySelectBank : CompPageBase
{
    ...
    protected void SubOk_Click(object sender, EventArgs e)
    {
        ...
        if (bankModel == null)
        {
            JScript.AlertMethod(this, "请选择银行！", JScript.IconOption.错误, "function() (){ location.replace('" + "PaySelectBank.aspx" + "'); }");
            return;
        }
        else 
        {
    ...
    {
        string strWhere = string.Empty;
        string bankname=this.txtbankname.Value;
