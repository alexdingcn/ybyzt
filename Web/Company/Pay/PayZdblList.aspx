<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PayZdblList.aspx.cs" Inherits="Company_Pay_PayZdblList" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnAdd").click(function () {
                //$(".tip").fadeIn(200);
                window.location.href = '../Order/OrderZdtsAdd.aspx?type=1';
            });
            ...
            $("#li_Reset").click(function () {
                window.location.href = 'PayZdblList.aspx';
            });
        ...
        function goInfo_cx(Id) {
            window.location.href = '../Order/OrderZdtsInfo.aspx?showtype=PayZdblList&KeyID=' + Id;
        }

        //补录
        function pay(ordid, start) {
            window.location.href = 'PaymentZdblEdit.aspx?start=' + start + '&KeyID=' + ordid;
        }
        //补录详情
        function goPreInfo(Id) {
            //window.location.href = 'PaymentInfo.aspx?KeyID=' + Id;
            window.location.href = '../Order/OrderZdtsInfo.aspx?showtype=PaymentZdblcxList&KeyID=' + Id;
        }
...
<body>
    ...
    <div class="place">
        <ul class="placeul">
            ...
            <li><a href="../pay/PayZdblList.aspx">账单收款补录</a></li>
        </ul>
    </div>
    <!--当前位置 end-->
        ...
        <div class="hidden">
            <ul style="width: 90%;">
             <li>账单日期：
                 ...
                 <li>账单编号:<input name="txtReceiptNo" type="text" id="txtReceiptNo" runat="server"
                        class="textBox" />&nbsp;&nbsp;
                    </li>
               <%-- <li>总价区间：
        ...
        <asp:Repeater runat="server" ID="rptOrder" OnItemCommand="rptOrder_ItemCommand">
            ...
            <ItemTemplate>
                <tr id='tr_<%# Eval("Id") %>'>
                    ...
                    <td>
                        <div class="tc"><a href="javascript:void(0)" onclick='goInfo_cx(<%# Eval("Id") %>)'>
                   ...
                   <td>
                    ...
                    <%-- <td>
                        <%# Common.GetUserName(Convert.ToInt32(Eval("CreateUserID").ToString()))%></div>
                    </td>--%>
                    <td>
                        <div class="tc"><%# Getmessage(Convert.ToInt32(Eval("OType")), Convert.ToInt32(Eval("Id")), Convert.ToInt32(Eval("PayState")), Convert.ToInt32(Eval("OState")))%>
                     &nbsp; <a href="javascript:void(0)"   onclick='goInfo_cx("<%# Eval("Id") %>")'  class="tablelinkQx" id="clikccz">账单详情</a></div>
