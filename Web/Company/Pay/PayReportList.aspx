    ...
    <uc1:top ID="top1" runat="server" ShowID="nav-2" />
        ...
        <!--当前位置 end--> 
            ...
            <div class="tools">
                <div class="left">
                    ...
                    <ul class="toolbar3">
                        <li>入账时间:
                        <asp:TextBox ID="TextBox1" Style="width: 100px;height:28px;" runat="server" class="Wdate" onFocus="WdatePicker({isShowWeek:true,onpicked:function() {$dp.$('ReporDays').value=$dp.cal.getP('W','W');$dp.$('HiddenField_Days').value=$dp.cal.getP('W','W');}})"></asp:TextBox>
                        </li>
                    </ul>
                    <ul class="toolbar3">
                        <li>流水号:<input name="" type="text" class="textBox"/></li>
                    </ul>
                    <ul class="toolbar3">
                        <li>代理商名称:<input name="" type="text" class="textBox"/></li>
                    </ul>
                </div>
            </div>
            <!--功能按钮 end-->
        ...
        <div class="tip" style="display: none;">
            ...
            <div class="tipinfo">
                ...
                <div class="lb">
                    <span>备注：</span><input name="txtSortIndex" type="text" class="textBox txtSortIndex"
