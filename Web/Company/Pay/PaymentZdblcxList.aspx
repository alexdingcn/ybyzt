<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaymentZdblcxList.aspx.cs" Inherits="Company_Pay_PaymentZdblcxList" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#li_Reset").click(function () {
                window.location.href = 'PaymentZdblcxList.aspx';
            });
            //新增按钮事件
    ...
    <uc1:top ID="top1" runat="server" ShowID="nav-2" />
        ...
        <!--补录明细审核 End-->
            ...
            <ItemTemplate>
                <tbody>
                    <tr>
                         <td> <a style=" text-decoration:underline;" href="javascript:void(0)"  onclick='goInfo(<%# Eval("OrderID") %>)'><%# Eval("ID")%> </a></td>
