...
public partial class Company_Pay_PayZdblList : CompPageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            Bind();
            if (!Common.HasRight(this.CompID, this.UserID, "1113"))
    ...
    public string Where()
    {
        ...
        {
            strWhere += " and PayState=" +Common.NoHTML( this.ddrPaytype.Value);
        }
