...
public partial class Company_Financing_SettlementInfo : CompPageBase
{
    ...
    {
        List<Hi.Model.PAY_Withdrawals> Lwithdrawals = new Hi.BLL.PAY_Withdrawals().GetList("", " isnull(dr,0)=0  and CompID=" + CompID + " and DisID=0", "");
        ...
        {
            Response.Redirect("SettlementAdd.aspx");
        }
    }
}