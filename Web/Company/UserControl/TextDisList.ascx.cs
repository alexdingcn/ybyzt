...
public partial class Disany_UserControl_TextDisList : System.Web.UI.UserControl
{
    private string disid = string.Empty;
    public string Name
    {
    ...
    public string Class
    {
        get { return txt_txtDisName.Attributes["class"]; }
        set { txt_txtDisName.Attributes.Add("class", value); }
    }
