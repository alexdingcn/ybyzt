<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TreeGtype.ascx.cs" Inherits="Company_UserControl_TreeDisAddr" %>
<style>
    .showDiv4
    {
        margin-left: 5px;
...
<div style="display: none;" class="showDiv4">
    <iframe src="../TreeDemo.aspx?type=7" class="ifrClass" scrolling="no" height="220px" frameborder="0"></iframe>
</div>
