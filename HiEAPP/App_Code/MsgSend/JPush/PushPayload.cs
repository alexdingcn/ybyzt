    ...
    public class PushPayload
    {
        ...
        */
        ...
        public bool IsGlobalExceedLength()
        {
            ...
            if (message!= null)
            {
                foreach (JsonConverter item in jSetting.Converters)
                {
                    string messageJson = JsonConvert.SerializeObject(this.message, item);
        ...
        public bool IsIosExceedLength()
        {
            if (this.notification != null)
            {
                if (this.notification.IosNotification != null)
                {
                    foreach (JsonConverter item in jSetting.Converters)
                    {
                        string iosJson = JsonConvert.SerializeObject(this.notification.IosNotification, item);
                        if (iosJson != null)
                        {
        ...
        public string ToJson()
        {
            ...
            return JsonConvert.SerializeObject(this, formatting, jSetting);
        }
