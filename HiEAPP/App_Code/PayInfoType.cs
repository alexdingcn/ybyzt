...
public class PayInfoType
{
    ...
    {
        string[] emails = new string[] { "ggh@moreyou.cn" };// ConfigCommon.GetNodeValue("Version.xml", "emails").Split(',');//
        Send("smtp.exmail.qq.com", 25, MailPriority.Normal, "servicedesk@moreyou.cn", "陌远科技运营服务", "F606d906", "servicedesk@moreyou.cn", "清算", null, null, emails, "关于后台清算结果的通知-YZT", message, new string[] { }, true, false, Encoding.GetEncoding(936), NullSmtp_SendCompleted);
