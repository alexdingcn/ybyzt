...
using System.Text;
 ...
 public   class ClsSystem
    {
        public static decimal kk = 0;//销售订单明细行数
        ...
        public static String nvl(Object objvalue1, Object objvalue2)
        {
            try
            {
                if (objvalue1.ToString() == "" || objvalue1 == null)
                    return objvalue2.ToString();
                return objvalue1.ToString();
            }
            catch (Exception)
            {
                return objvalue2.ToString();
        ...
        public static Boolean checkNum(string objNum)
        {
            try
            {
                decimal num = decimal.Parse(objNum);
                return true;
            }
            catch (Exception)
            {
