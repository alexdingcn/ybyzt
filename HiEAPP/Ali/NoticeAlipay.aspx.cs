...
public partial class Ali_NoticeAlipay : System.Web.UI.Page
{
            ...
            if (verifyResult)//验证成功
            {
                ...
                if (Request.Form["trade_status"] == "TRADE_FINISHED" || Request.Form["trade_status"] == "TRADE_SUCCESS")
                {
                    ...
                    if (orderModel != null)
                    {
                        ...
                        try
                        {
                            order = new Hi.BLL.DIS_Order().UpdateOrderPstate(con, orderModel.ID, payM.PayPrice + prepayPrice - Convert.ToDecimal(ClsSystem.gnvl(payM.vdef5,"0")), sqlTrans);
